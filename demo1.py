...
"""
Se entrena un chatbot e interactua con el usuario.
"""
...
if len(sys.argv) == 2:
    ...
    # por default se cargara Primero Sueño que está en el archivo suenio.txt
    nombre = "suenio"
...
ruta_log_user = os.path.join(dir_user_logs, "demo1." + nombre + ".userlog.txt")
